...
T,71,20,V,86,170,0,1,1,1,B,L,0,0|
T,81,20,V,86,225,0,1,1,1,B,L,0,0|
T,91,20,V,86,260,0,1,1,1,B,L,0,0|

T,101,20,V,68,12,0,1,1,1,B,L,0,0|
T,102,20,V,68,170,0,1,1,1,B,L,0,0|
T,103,20,V,68,225,0,1,1,1,B,L,0,0|
T,104,20,V,68,260,0,1,1,1,B,L,0,0|

T,105,20,V,54,12,0,1,1,1,B,L,0,0|
T,106,20,V,54,170,0,1,1,1,B,L,0,0|
T,107,20,V,54,225,0,1,1,1,B,L,0,0|
T,108,20,V,54,260,0,1,1,1,B,L,0,0|

T,109,20,V,40,12,0,1,1,1,B,L,0,0| 
T,110,20,V,40,170,0,1,1,1,B,L,0,0|
T,111,20,V,40,225,0,1,1,1,B,L,0,0|
T,112,20,V,40,260,0,1,1,1,B,L,0,0|

T,113,20,V,26,12,0,1,1,1,B,L,0,0|
T,114,20,V,26,170,0,1,1,1,B,L,0,0|
T,115,20,V,26,225,0,1,1,1,B,L,0,0|
T,116,20,V,26,260,0,1,1,1,B,L,0,0|
...
@{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        var color = (detail != null && detail.COLORCODE != null) ? detail.COLORCODE.Replace("\"", "'") : "";
